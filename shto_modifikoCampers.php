  ...
  <section class="forma">
    <div class="container d-flex flex-column align-items-center ">
      ...
      <form class="col-lg-6 col-12 mt-3 p-5 bg-light shadow-lg" method="POST">
        ...
        <?php endif; ?>
        <input type="hidden" name="camperid" value="<?php if (isset($_GET['editCamper'])) {
                        echo $camper['camperid'];
                           }?>">
        <div class="mb-2">
          <label for="name" class="form-label">Name</label>
          <input type="text" name="name" value="<?php  if (isset($_GET['editCamper'])) {
                            echo $camper['name'];
                               }?>" class="form-control">
        ...
        <div class="mb-2">
          ...
          <input type="text" name="surname" value="<?php  if (isset($_GET['editCamper'])) {
                            echo $camper['surname'];
                               }?>" class="form-control">
        </div>
        <div class="mb-2">
          <label for="address" class="form-label">Address</label>
          <input type="text" name="address" value="<?php  if (isset($_GET['editCamper'])) {
                            echo $camper['address'];
                               }?>" class="form-control">
        </div>
        <div class="mb-2">
          <label for="phone" class="form-label">Phone</label>
          <input type="text" name="phone" value="<?php  if (isset($_GET['editCamper'])) {
                            echo $camper['phone'];
                               }?>" class="form-control">
        </div>
        ...
        <div class="mb-4">
          ...
          <select class="form-select" name="camp" id="inputGroupSelect01">
            ...
            <option value="<?php  echo $row['campid'];?>" <?php if (isset($_GET['editCamper'])) {
                                if ($row['campid'] == $camper['campid']) {
                                    echo 'selected' ;
                                }
                            } ?>>
