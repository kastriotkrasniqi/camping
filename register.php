    ...
    <div class="container left-side ">
      ...
      <form class="col-lg-8 col-12 col-sm-12 p-5 ms-auto me-auto" id="register-form" method="POST">
        ...
        <div class="mb-2">
          ...
          <input type="text" name="name" class="form-control bg-light p-2" value="<?php if (!empty($_POST['name'])) {
                            echo $_POST['name'];
                               }?>" />
        </div>
        <div class="mb-2">
          <label for="surname" class="form-label">Surname</label>
          <input type="text" name="surname" class="form-control bg-light p-2" value="<?php if (!empty($_POST['surname'])) {
                            echo $_POST['surname'];
                               }?>" />
        </div>
        <div class="mb-2">
          <label for="email" class="form-label">Email address</label>
          <input type="email" name="email" class="form-control bg-light p-2" value="<?php if (!empty($_POST['email'])) {
                            echo $_POST['email'];
                               }?>" />
        ...
        <div class="mb-3">
          ...
          <input type="password" name="password" class="form-control bg-light p-2" value="<?php if (!empty($_POST['password'])) {
                            echo $_POST['password'];
                               }?>" />
        </div>
