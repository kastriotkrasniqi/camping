  ...
  <section class="forma" id="forma">
    <div class="container d-flex flex-column align-items-center ">
      ...
      <form class="col-lg-6 col-12 mt-3 p-5 bg-light shadow-lg" method="POST">
        ...
        <?php endif; ?>
        <div class="mb-2">
          <input type="hidden" name="id" value="<?php if (isset($_GET['editTeam'])) {
                        echo $team['teamid'];
                                                } ?>">
          <label for="name" class="form-label">Name</label>
          <input type="text" name="name" value="<?php if (isset($_GET['editTeam'])) {
                        echo $team['name'];
                                                } ?>" class="form-control">
        ...
        <div class="mb-2">
          ...
          <input type="tel" name="phone" value="<?php if (isset($_GET['editTeam'])) {
                        echo $team['phone'];
                                                } ?> " class=" form-control">
        </div>
        <div class="mb-2">
